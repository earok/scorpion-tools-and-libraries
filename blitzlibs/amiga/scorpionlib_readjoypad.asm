;https://github.com/jotd666/pacman500/blob/main/src/ReadJoypad.s
...
_read_joystick:
    ...
    ENDC
		...
		move.l d1,d2 ;We get the CD32 pad button read instruction from Scorpion
...
.direction
    ...
    IFND    IGNORE_JOY_DIRECTIONS
		...
		;Reworked to match Mega Drive bit scheme
...
no_further_button_test
	...
	ENDC
		...
		;Move FIRE1/FIRE2 into word area
		move.l d0,d7
		swap.w d7
		move.w d7,d6
		...
		and.w #$F,d0
		or.w d7,d0 ;Add fire1+2
		or.w d6,d0 ;Add fire3+cd32 bits
